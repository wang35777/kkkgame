...
namespace Server.MirEnvir
{
    ...
    public class Envir
    {
        ...
        static Envir()
        {
            ...
            CharacterReg =
                new Regex(@"^[A-Za-z0-9-\u4E00-\u9FA5]{" + Globals.MinCharacterNameLength + "," + Globals.MaxCharacterNameLength +
                          "}$");
        ...
        private void FillMagicInfoList()
        {
            ...
            //if (!MagicExists(Spell.HealingCircle)) MagicInfoList.Add(new MagicInfo { Name = Tr("HealingCircle"),Spell = Spell.ImmortalSkin, Icon = ?, Level1 = ?, Level2 = ?, Level3 = ?, Need1 = ?, Need2 = ?, Need3 = ?, BaseCost = ?, LevelCost = ?, DelayBase = ?, DelayReduction = ? });
            ...
            //if (!MagicExists(Spell.MoonMist)) MagicInfoList.Add(new MagicInfo { Name = Tr("MoonMist"),Spell = Spell.ImmortalSkin, Icon = ?, Level1 = ?, Level2 = ?, Level3 = ?, Need1 = ?, Need2 = ?, Need3 = ?, BaseCost = ?, LevelCost = ?, DelayBase = ?, DelayReduction = ? });
            ...
            try
            {
                ...
                try
                {
                    while (Running)
                    {
                        ...
                        if (ts > 30)
                            SMain.Enqueue(string.Format("cost {0}ms.", ts));
                        int sleepTime = (int)(50 - ts);
                        if (sleepTime > 0)
