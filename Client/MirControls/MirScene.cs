...
namespace Client.MirControls
{
    public abstract class MirScene : MirControl
    {
        ...
        private static void Disconnect(S.Disconnect p)
        {
            ...
            {
                case 0:
                    MirMessageBox.ShowTr("Disconnected: Server is shutting down.", true);
                    break;
                case 1:
                    MirMessageBox.ShowTr("Disconnected: Another user logged onto your account.", true);
                    break;
                case 2:
                    MirMessageBox.ShowTr("Disconnected: Packet Error.", true);
                    break;
                case 3:
                    MirMessageBox.ShowTr("Disconnected: Server Crashed.", true);
                    break;
                case 4:
                    MirMessageBox.ShowTr("Disconnected: Kicked by Admin.", true);
                    break;
                case 5:
                    MirMessageBox.ShowTr("Disconnected: Maximum connections reached.", true);
                    break;
            }
